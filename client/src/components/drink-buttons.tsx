...
export function DrinkButtons({ onOrderDrink, isPreparingDrink }: DrinkButtonsProps) {
  return (
    <div className="flex flex-wrap justify-center gap-6 mb-8">
      ...
      <button 
        className="drink-button sketch-border bg-cafe-accent text-cafe-brown px-8 py-4 font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
            ...
            <path d="M8 10l8 0" stroke="currentColor" strokeWidth="1.5" opacity="0.7"/>
            <circle cx="10" cy="8" r="0.5" fill="currentColor" opacity="0.8"/>
            <circle cx="14" cy="8" r="0.5" fill="currentColor" opacity="0.8"/>
          </svg>
